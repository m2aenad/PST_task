...
#define PIN_RESET 35
#define PIN_CANDY_DISPENSE_DETECT 27 // Beambreaker dispenser port, closer to motor, with yellow stickers on Yana's setup
#define PIN_USER_EXTRACTION_DETECT 7 // Beambreaker collector port, closer to the battery power
